...
def main(options,args) :
    ...
    cont.get_cluster_collection('TriggerPadTaggerClusters_sim')
    cont.get_track_collection('TriggerPadTracks_sim')
    ...
    for i in range(cont.tree.numentries):
        ...
        beamFracC=cont.get_data('TriggerPadTaggerClusters_sim', 'beamEfrac',i)
        for frac in beamFracC : 
            hBeamEfrac.Fill(frac)
        beamFracT=cont.get_data('TriggerPadTracks_sim', 'beamEfrac',i)
